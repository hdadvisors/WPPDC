...
# Install hdatools if not already installed (private repo - requires GITHUB_PAT)
if (!require("hdatools", quietly = TRUE)) {
  ...
  if (Sys.getenv("GITHUB_PAT") == "") {
    stop("GITHUB_PAT not found. Please set it in your .Renviron file.")
  }
  
  # Install from private GitHub repo using PAT
